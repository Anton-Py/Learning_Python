def get_order_cost(product_1_quantity, product_1_price, product_2_quantity, product_2_price):
    ...
    small_discount = 0.05
    big_discount = 0.10
    products_order_for_discount = 1000
    products_quantity_for_discount = 10

    if products_quantity >= products_quantity_for_discount and order_cost >= products_order_for_discount:
    ...
    elif order_cost >= products_order_for_discount:
        orders_cost_including_discount = order_cost - order_cost * small_discount
    else:
        return order_cost
...
print("Стоимость заказа равна:", get_order_cost(1, 150, 2, 200))
